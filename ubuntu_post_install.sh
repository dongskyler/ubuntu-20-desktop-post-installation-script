...
sudo apt install zlib1g-dev build-essential libssl-dev libreadline-dev libyaml-dev libsqlite3-dev sqlite3 libxml2-dev libxslt1-dev libcurl4-openssl-dev software-properties-common libffi-dev python-dev -y
...
wget https://downloads.slack-edge.com/linux_releases/slack-desktop-4.4.3-amd64.deb -P ~/Downloads/
sudo apt install ~/Downloads/slack-desktop-*-amd64.deb -y
...
rm ~/Downloads/slack-desktop-*-amd64.deb
